...
function createQuestionElement(index) {
  ...
  function displayResult() {
    ...
    score.append(' <form id="count_power" action="power.php" method="POST"><input onClick="get_power()" id="user_name" class="modal_inputs2" name="name" type="text" placeholder="Введите имя"  required="required" /><input class="modal_inputs2" id="tele" name="tel" type="text" placeholder="Введите телефон" required="required"/><input id="user_power"  name="user_power"/><br><button type="submit" class="back_btn personal_model">Подобрать кондиционер</button></form>');

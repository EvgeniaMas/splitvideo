! function(global) {
    ...
    ! function() {
            ...
            var r, o = {
                ...
                i = function() {
                    var e = {
                        ...
                        v = function(e, t, r) {
                            "string" == typeof e && (e = [e]), d || (d = !0, p(w)), m.push({
                                deps: e,
                                cb: function(e, o) {
                                    o ? (r || s)(o) : t.apply(n, e)
                                }
        ...
        function() {
            ...
            ! function(r) {
                ...
                for (var _ in E) E.hasOwnProperty(_) && (g[_] = E[_]);
                var w = {
                        debug: !1,
                        Deferred: v,
                        Promise: g,
                    ...
                    b = !0;
                "object" == typeof n && "object" == typeof n.exports && (n.exports = w, b = !1), "object" == typeof t && (t.define("vow", function(e) {
                    e(w)
                }), b = !1), "function" == typeof e && (e(function(e, t, n) {
                    n.exports = w
                }), b = !1), b && (r.vow = w)
    ...
    ! function(e, t, n) {
        ...
        i = {
            ...
            define: function(e, n, r, o) {
                ...
                if (l.hasOwnProperty(e) || (l[e] = {
                    ...
                    if ("string" != typeof a)
                        for (var p = 0, d = a.length; p < d; p++) this._createKeyStorageRef(e, a[p], s);
        ...
        function(e) {
        ...
        }), ym.modules.require("main", function() {}), ym.modules.define("cnst.env", function(e) {
            e({
                "lang": "ru"
            })
            ...
            e(function(e) {
                ...
                var u = {
                    ...
                    c = ["fullscreenControl", "rulerControl", "routeEditor", "searchControl", "trafficControl", "zoomControl", "geolocationControl"];
                n.isEnterprise || (u.searchControlProvider = "yandex#search", c.push("typeSelector"));
                var l = new i.Map(e, {
    ...
    ym.modules.define("cnst.current-script", ["config"], function(e, t) {
        ...
        if (!currentScript || !currentScript.parentNode)
            for (var r, o = document.getElementsByTagName("script"), i = 0, s = o.length; i < s; i++)
        ...
        t(E, y);
        var _ = r("EmptyResultReject", "Reject");
        t(_, y);
        ...
        e({
            ...
            "originalUrl": "api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Ab3e0520a21fe5ead1234f01e8872a2aa71a884e880f1fa815c8dc1c0a9755844&amp;width=100%25&amp;height=400&amp;lang=ru_RU&amp;scroll=false",
        ...
        e({
            ...
            "maps": [{
                "properties": {
                    "sid": "constructor:b3e0520a21fe5ead1234f01e8872a2aa71a884e880f1fa815c8dc1c0a9755844",
                    "created": 1520791687,
                    "updated": 1520791705,
                    "authorUid": "341008832",
                    "access": "public",
                ...
                "state": {
                    "size": [500, 400],
                    "center": [132.93990893254073, 42.84245900422752],
                    "zoom": 17,
                    "type": "yandex#map",
                    "traffic": {
                        "shown": false
                ...
                "geoObjects": {
                    ...
                    "features": [{
                        ...
                        "id": "117637171",
                        "properties": {
                            "name": " <p class='logotip'></p><br> <p class='address'>г. Находка, <br>Угольная 61, база ТМТ</p>",
                            "description": "",
                            "iconContent": "",
                            "iconCaption": ""
                        },
                        "geometry": {
                            "type": "Point",
                            "coordinates": [132.948584, 42.843749]
                        },
                        "options": {
                            "zIndex": 800000000,
                            "order": 800000000,
        ...
        var o = {
            ...
            "size": ["100%", "400"],
            "sid": "b3e0520a21fe5ead1234f01e8872a2aa71a884e880f1fa815c8dc1c0a9755844",
            "elementId": "",
            "lang": "ru_RU",
        ...
        function i(e, i, s, a) {
            ...
            for (var l = 0, f = u.length; l < f; ++l) {
                var p = u[l][1],
                    d = s[p];
                if (r(d))
                    for (var m = a[p].__package, h = 0; h < m.length; ++h) t(i, m[h][0], m[h][1]);
                else t(i, d, a[p])
            }
            return i
        }
        ...
        function r() {
            if (u = !1, a.length) {
                if (o || (o = document.createElement(p ? "link" : "style"), o.type = "text/css", o.rel = "stylesheet", o.setAttribute && o.setAttribute("data-ymaps", "css-modules"), l && f && l.style_nonce && o.setAttribute && o.setAttribute("nonce", l.style_nonce)), o.styleSheet) s += i, o.styleSheet.cssText = s, o.parentNode || document.getElementsByTagName("head")[0].appendChild(o);
                else {
                    if (p) {
                        var e = new Blob([i], {
                                type: "text/css"
                            }),
                            t = c.createObjectURL(e);
        ...
        var o, i = "",
            ...
            a = [],
            u = !1,
            c = window.URL || window.webkitURL || window.mozURL,
            l = n.isSupported && ym.env.server && ym.env.server.params.csp,
            f = n.isNonceSupported,
            p = l && (!l.style_nonce || !f);
        e(function(e, n) {
        ...
        Parser.prototype.scanners["{{"] = {
            ...
            if (i.test(a)) {
                var l, f = a.match(i),
                    p = a.split(f[0]);
                if (o = f.length, a = p[0], l = a + "." + removeQuotes(trim(f[0].replace("[", "").replace("]", ""))), p = p[1], o > 1)
                    for (r = 1; r < o; r++) {
                        var d = f[r];
        ...
        var i = n.ns,
            s = window[i],
            a = i + "loader";
        if (s && !window[a]) s.ready(o);
        else if (window[a]) window[a].queue.push(o);
        else {
            var u = "fid" + n.tid,
                c = n.isEnterprise ? t.enterpriseHost : t.host;
        ...
        e(function(e) {
            ...
            function a() {
                ...
                if (e.container.isFullscreen()) i = [s.clientWidth, s.clientHeight];
                else {
                    var u = e.container.getParentElement().getBoundingClientRect();
                    i = [u.width, u.height]
                }
                for (var c = t.minContainerSize, l = "0,0" === i.toString(), f = i[0] < c[0], p = !l && (f || i[1] < c[1]), d = ["rulerControl", "routeEditor", "searchControl", "trafficControl", "geolocationControl"], m = 0, h = d.length; m < h; m++) e.controls.get(d[m]).options.set("visible", !p);
                !e.state.get("narrowMode") && e.options.get("suppressMapOpenBlock", !1) || (e.state.get("narrowMode") !== f ? f ? r.show(e) : r.hide(e) : f && r.onResize(e)), e.state.get("compactMode") !== p && (p ? (n.isEnterprise || e.controls.remove("typeSelector"), e.controls.get("zoomControl").options.set({
                    position: {
                        top: 10,
                        left: 10
                    },
                    size: "small"
                })) : (n.isEnterprise || e.controls.add("typeSelector"), e.controls.get("zoomControl").options.unset(["position", "size"]))), l ? o || (o = window.setInterval(a, 200)) : o && (window.clearInterval(o), o = 0), e.state.set({
                    compactMode: p,
                    narrowMode: f
                })
            }
    ...
    }), ym.modules.define("distribution", ["config", "params", "ymaps", "ymaps-counter", "ie-version", "cnst.localization"], function(e, t, n, r, o, i, s) {
        function a(e) {
            function t(e) {
                var t = e.getElement();
            ...
            v = "cnst_" + (new Date).getTime();
            var n = v + "-button",
                o = r.util.dom.styleSheet;
            o.addStyle("." + n, "{display: block; text-align:center;}"), o.addStyle("." + n + "-inner", "{ " + d + "} "), h = new r.control.Button({
                data: {
                    content: ['<ymaps class="' + n + '">', '<ymaps class="' + v + " " + n + '-inner">', f, "</ymaps>", "</ymaps>"].join("")
                },
                options: {
                    maxWidth: "99999",
                    selectOnClick: !0
            ...
            }), h.getLayoutSync() ? t(h.getLayoutSync()) : h.getLayout().then(t), e.panes.get("copyrights").getElement().style.marginBottom = "29px", u(e)
        }

        function u(e) {
            function t(t) {
                var n = t.getElement().querySelector("." + v),
            ...
            i < 9 || h && (h.getLayoutSync() ? t(h.getLayoutSync()) : h.getLayout().then(t))
        }
        ...
        var f = s.move_to_map,
            p = [],
            d = "background-size: 20px 36px; background-repeat: no-repeat; background-position: left center;display: inline-block;";
        i < 9 && (d = "");
        var m, h, v;
        e({
            show: function(e) {
                ...
                }), a(e), c(e), h.events.add("click", function() {
            ...
            hide: function(e) {
                h && e.controls.remove(h), l(e), e.panes.get("copyrights").getElement().style.marginBottom = "0px", e.options.unset(["copyrightLogoVisible", "suppressMapOpenBlock"]), m && (m.removeAll(), m = null)
            }
        })
